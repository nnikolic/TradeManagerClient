...
public class JAutoComboBox extends JComboBox {
	...
	public JAutoComboBox(java.util.List list) {
		...
		setModel(new DefaultComboBoxModel(list.toArray()) {
			...
			public Object getElementAt(int index) {
				...
				return autoTextFieldEditor.getAutoTextFieldEditor().getDataList().get(index).toString();
			}
	...
	public Object getSelectedObject() {
		...
		if(index>=0){
			return autoTextFieldEditor.getAutoTextFieldEditor().getDataList().get(index);
		}
		return null;
	}
